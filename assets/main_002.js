! function(e, t) {
    ...
    function x(e, t, n) {
        ...
        return n = n || Ve(e), n && (a = n.getPropertyValue(t) || n[t]), n && ("" !== a || Z.contains(e.ownerDocument, e) || (a = Z.style(e, t)), Ue.test(a) && $e.test(t) && (r = s.width, i = s.minWidth, o = s.maxWidth, s.minWidth = s.maxWidth = s.width = a, a = n.width, s.width = r, s.minWidth = i, s.maxWidth = o)), void 0 !== a ? a + "" : a
    }
    ...
    var ie = function(e) {
        ...
        x = t.support = {}, T = t.isXML = function(e) {
            ...
            var n = _.attrHandle[t.toLowerCase()],
                r = n && J.call(_.attrHandle, t.toLowerCase()) ? n(e, t, !M) : void 0;
            ...
            var t, n = [],
                r = 0,
                i = 0;
            if (D = !x.detectDuplicates, O = !x.sortStable && e.slice(0), e.sort(B), D) {
        ...
        }, x.sortStable = q.split("").sort(B).join("") === q, x.detectDuplicates = !!D, j(), x.sortDetached = i(function(e) {
    ...
    Z.extend({
        ...
        index: function(e) {
            return e ? "string" == typeof e ? B.call(Z(e), this[0]) : B.call(this, e.jquery ? e[0] : e) : this[0] && this[0].parentNode ? this.first().prevAll().length : -1
        },
        add: function(e, t) {
        ...
        style: function(e, t, n, r) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                var i, o, a, s = Z.camelCase(t),
                    u = e.style;
                return t = Z.cssProps[s] || (Z.cssProps[s] = E(u, s)), a = Z.cssHooks[t] || Z.cssHooks[s], void 0 === n ? a && "get" in a && void 0 !== (i = a.get(e, !1, r)) ? i : u[t] : (o = typeof n, "string" === o && (i = Be.exec(n)) && (n = (i[1] + 1) * i[2] + parseFloat(Z.css(e, t)), o = "number"), null != n && n === n && ("number" !== o || Z.cssNumber[s] || (n += "px"), G.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (u[t] = "inherit"), a && "set" in a && void 0 === (n = a.set(e, n, r)) || (u[t] = n)), void 0)
            }
        },
        css: function(e, t, n, r) {
            var i, o, a, s = Z.camelCase(t);
            return t = Z.cssProps[s] || (Z.cssProps[s] = E(e.style, s)), a = Z.cssHooks[t] || Z.cssHooks[s], a && "get" in a && (i = a.get(e, !0, n)), void 0 === i && (i = x(e, t, r)), "normal" === i && t in Je && (i = Je[t]), "" === n || n ? (o = parseFloat(i), n === !0 || Z.isNumeric(o) ? o || 0 : i) : i
        }
    }), Z.each(["height", "width"], function(e, t) {
        Z.cssHooks[t] = {
            get: function(e, n, r) {
                return n ? Xe.test(Z.css(e, "display")) && 0 === e.offsetWidth ? Z.swap(e, ze, function() {
                    return k(e, t, r)
                }) : k(e, t, r) : void 0
            },
            set: function(e, n, r) {
        ...
        css: function(e, t) {
            return me(this, function(e, t, n) {
                var r, i, o = {},
                    a = 0;
                if (Z.isArray(t)) {
                    for (r = Ve(e), i = t.length; i > a; a++) o[t[a]] = Z.css(e, t[a], !1, r);
                    return o
                }
    ...
    return Z.noConflict = function(t) {
        ...
        var n, r = t.getDocument().referrer,
            ...
            a = /^https?:\/\/(?:[^?\/]+\.)?(?:localhost|(?:nytimes|nytlabs|stumbleupon|starbucks)\.com|(?:newsdev\.net))(?:\:[1-9][0-9]*)?\//;
...
JSON || (JSON = {}),
    function() {
        ...
        var B = T["iframe-eventsource"] = function() {
            var e = this;
        ...
        J.prototype = new H, J.enabled = function() {
        ...
        var i = n.View.extend({
            ...
            initialize: function() {
                t.bindAll(this, "handleBreakpoint", "handleKeyDown", "handleOrientation", "handlePageReady", "handleResizeDebounce", "handleResizeThrottle", "handleScrollDebounce", "handleScrollThrottle", "handleScrollUnthrottled", "handleHashChange", "handleSkipTo", "handleContentFocus", "handleUserActivity", "handleOnFocus", "handleBlur"), e.ajaxSetup({
                    cache: !0
                }), this.isReady = !1, this.initEdition(), this.initMetaTags(), this.initComponentToggle(), this.initUrlParams(window.location.search), this.$document.ready(this.handlePageReady), this.initCanonical(), this.currentlyHasFocus = document.hasFocus()
            },
            ...
            adjustScrollDepth: function(t, n) {
                var r, i = this,
                    ...
                    s = 1;
                this.isScrolling !== !0 && ((t === this.KEYS.PAGE_UP || t === this.KEYS.SPACE && n) && (s = -1), r = o.top + s * (o.height - a - 40), 0 > r && (r = 0), this.isScrolling = !0, e("html, body").animate({
                    scrollTop: r
            ...
            initEdition: function() {
                ...
                e = e.match(/\w+$/)[0].toLowerCase(), "us" !== e && "global" !== e && (r.deleteCookie("NYT-Edition"), e = "us"), window.location.host.indexOf("international") > -1 && (e = "global", this.setEdition(e)), this.edition = e, window.magnum.addEditionClass(e)
            },
            setEdition: function(e) {
                var t = "NYT-Edition";
                "us" === e ? (r.writeCookie(t, "edition|US"), this.edition = e) : "global" === e && (r.writeCookie(t, "edition|GLOBAL"), this.edition = e)
            },
            getEdition: function() {
                return this.edition
            },
        ...
        var s = r.extend(i).extend({
            ...
            loadData: function() {
                var t = e("#userinfo").text();
                t ? (this.set(e.parseJSON(t).data), this.trigger("sync")) : this.fetch()
            },
            sync: function(e, t, r) {
                var i;
                return i = this.pageManager.flag("dfpAds") && this.pageManager.$html.hasClass("dfp-enabled") ? a.www + "/svc/web-products/userinfo-v3.json" : a.www + "/svc/web-products/userinfo-v2.json", r.url = i, r.cache = !1, a.www !== "//" + window.location.host && (r.dataType = "jsonp", r.jsonpCallback = "userInfoCallback", r.url += "p", r.data = {
            ...
            isRealEstateSubscriber: function() {
                return this.hasEntitlement("REBG")
            },
            getImageSource: function(e) {
                var t = a.profileImage + "/" + e.substring(4, 0) + "/" + e.substring(4) + "/cropped-" + e + ".jpg";
                return t
            },
        ...
        var s = r.extend(i).extend({
            ...
            sync: function(e, t, r) {
                return r.url = o.myaccount + "/svc/group-accounts/v1/group-name?" + a.getUserId(), r.cache = !0, r.xhrFields = {
                    withCredentials: !0
                }, n.sync(e, t, r)
            },
            parse: function(e) {
        ...
        var s = r.extend({
            ...
            sync: function(e, t, r) {
                return r.url = a.www + "/svc/profile/token.json", r.cache = !1, a.www !== "//" + window.location.host && (r.dataType = "jsonp", r.jsonpCallback = "tokenCallback", r.url += "p"), n.sync(e, t, r)
            },
            parse: function(e) {
                return e.data
            },
        ...
        var i = r.extend({
            ...
            addUserCapabilities: function() {
                n.isLoggedIn() && this.$html.addClass("user-logged-in"), n.isPremierSubscriber() && this.$html.addClass("user-times-premier"), n.isOpinionSubscriber() && !n.isWebSubscriber() && this.$html.addClass("user-opinion"), n.isCookingSubscriber() && !n.isWebSubscriber() && this.$html.addClass("user-cooking"), n.isCrosswordsSubscriber() && this.$html.addClass("user-crosswords"), n.isRealEstateSubscriber() && this.$html.addClass("user-realestate"), n.isWebSubscriber() && this.$html.addClass("user-web")
            }
        });
        return new i
        ...
        "use strict";
        var a = i.extend({
            infoUrl: o.msgSocket + "/endpoints.json?jsoncallback=?",
            url: "",
            apps: {},
            states: {
                notConnected: 0,
            ...
            maxReconnects: 5,
            initialize: function() {
                this.state = this.states.notConnected, this.subscribe(this, "nyt:fabrik-client-connected", this.login)
            },
            ...
            getWebSocketsUrl: function() {
                var t = this;
                this.state !== this.states.connecting && (this.state = this.states.connecting), e.ajax({
                    dataType: "json",
                    url: this.infoUrl,
                    success: function(e) {
                        e.http_sockjs_url && (t.url = e.http_sockjs_url, t.initWebSockets())
                    },
                    error: function() {
            ...
            initWebSockets: function() {
                var e = this;
                r && this.url && this.state !== this.states.connected && this.state !== this.states.stopConnecting && (this.webSocket = new r(this.url, null, this.sockjsOptions), this.webSocket.onopen = function() {
            ...
            publish: function(e) {
                this.webSocket && this.webSocket.readyState === r.OPEN && "undefined" != typeof r && null !== r && this.webSocket.send(JSON.stringify(e))
            },
            login: function(e) {
                var t, n, r = e.apps;
            ...
            onMessage: function(e, t) {
                var n, r, i, o = t.apps;
                if (e && e.data && "start" !== e.data.type && "finish" !== e.data.type) {
                    i = e.data.product + "." + e.data.project;
                    for (n in o) o.hasOwnProperty(n) && (r = o[n], r.fabrikApp === i && r.handleMessage(e.data, r.collection))
                }
            },
    ...
    function(e, t) {
        "use strict";
        if ("undefined" != typeof exports) exports.Auth = t(null, $);
        else if ("function" == typeof define && define.amd) define("foundation/lib/auth/userauth", ["foundation/hosts", "jquery/nyt"], function(e, n) {
            return t(e, n)
        });
        else if ("object" == typeof e.NYTD) {
            var n = e.NYTD,
                r = t(n.Hosts, n.jQuery);
            n.Auth = n.Auth || {}, n.Auth.register = r.register, n.Auth.login = r.login, n.Auth.getToken = r.getToken
        }
    }(this, function(e, t) {
        "use strict";
        var n, r, i, o, a, s = e ? e.www ? e.www : e.wwwHost : "//www.nytimes.com",
            u = e ? e.myaccount ? e.myaccount : e.myaccountHost : "https://myaccount.nytimes.com",
            c = s + "/svc/profile/token.jsonp?callback=?",
            l = 5e3,
            f = 6e5,
            d = "X-Nyt-Sartre-Token",
            h = u + "/register",
            p = u + "/auth/login",
            g = "timeout",
            m = "corrupt",
            ...
            y = function(e) {
                var i = h + "?" + k(),
                    o = function() {
                        ...
                        t(document.body).append(o), t("#authRegiForm input[name=password1]").val(e.password), t("#authRegiForm input[name=password2]").val(e.confPassword), t("#authRegiForm").submit()
                    },
                    a = function() {
            ...
            b = function(e) {
                var i = p + "?" + k(),
                    o = function() {
                        var o = ['<form action="', i, '" method="POST" class="hidden" id="authLoginForm">', '<input name="is_continue" value="1" type="text">', '<input name="userid" value="', e.user, '" type="text">', '<input name="password" type="password">', '<input name="remember" value="', e.remember, '" type="text">', '<input name="token" value="', n, '" type="text">', '<input name="expires" value="', r, '">', "</form>"].join("");
                        t(document.body).append(o), t("#authLoginForm input[name=password]").val(e.password), t("#authLoginForm").submit()
                    },
                    a = function() {
                        window.location.replace(i)
                    };
            ...
            w = function() {
                ...
                if (a = new t.Deferred, S()) return a.resolve(n, d, !0), a.promise();
                if (o) return a.reject(v), a.promise();
                i = !0;
                var e = setTimeout(function() {
                    i = !1, _(), a.reject(g)
                }, l);
                return t.getJSON(c, null, function(t) {
                    i = !1, t && t.data && t.data.token ? (n = t.data.token, clearTimeout(e), T(), a.resolve(n, d, !1)) : (_(), clearTimeout(e), a.reject(m))
                }), a.promise()
            },
            x = function(e, t, n) {
                var r = "/oauth/" + t + "-link";
                return u + r + "?type=login&URI=" + e + (n ? "&view=popup" : "") + "&flow=HPLI"
            },
            _ = function() {
                o = !0, setTimeout(E, 3e5)
            },
            E = function() {
                o = !1
            },
            ...
            k = function() {
                ...
                return n.search.length > 1 && (e = n.search.substr(1), e = e.replace(/(\?|&)?gwh=([^&]+)/g, ""), e = e.replace(/(\?|&)?gwt=([^&]+)/g, ""), e = e.replace(/%/g, "Q"), r.OQ = e), t.param(r)
            };
        return {
            register: y,
            login: b,
        ...
        return t
    }), define("foundation/lib/polyfills/balancetext", ["foundation/views/page-manager", "jquery/nyt"], function(e, t) {
        "use strict";
        ! function(e, t) {
            var n = function(e, t, n) {
                ...
                return function() {
                    ...
                    var o = this,
                        a = arguments;
                    r ? clearTimeout(r) : n && e.apply(o, a), r = setTimeout(i, t || 200)
                }
            };
            e.fn[t] = function(e) {
        ...
        function(t) {
            ...
            function r() {
                t(".has-cover-media").find("#story-heading").balanceText(), t(".has-cover-media").find("#story-deck").balanceText()
            }
            var i;
            ...
            var o = function(e, t) {
                    var n, r = /\s(?![^<]*>)/g;
                    if (!i)
                        for (i = []; null !== (n = r.exec(e));) i.push(n.index);
                    return -1 !== i.indexOf(t)
                },
                a = function(e) {
                    e.removeAttr("style"), e.find('br[data-owner="balance-text"]').replaceWith(" ");
                    var n = e.find('span[data-owner="balance-text"]');
                    if (n.length > 0) {
                        var r = "";
                        n.each(function() {
                            r += t(this).text(), t(this).remove()
                        }), e.html(r)
                    }
                },
                s = function(e, t) {
                    return 0 === t || t === e.length || o(e, t - 1) && !o(e, t)
                },
                u = function(e, t, n, r, i, o, a) {
                    for (var u;;) {
                        for (; !s(t, o);) o += i;
                        if (e.html(t.substr(0, o)), u = e.width(), 0 > i ? r >= u || 0 >= u || 0 === o : u >= r || u >= n || o === t.length) break;
                        o += i
                    }
                    a.index = o, a.width = u
                },
            ...
            t.fn.balanceText = function() {
                return this.each(function() {
                    ...
                    var g = e.width(),
                        m = e.height(),
                        v = "pre-wrap" === f ? 0 : c(e, m);
                    if (s > 0 && g > s && r > g) {
                        for (var y = e.html(), b = "", w = "", x = Math.round(l / m), _ = x; _ > 1;) {
                            i = null;
                            ...
                            u(e, y, s, E, -1, T, S);
                            var k = new n;
                            T = S.index, u(e, y, s, E, 1, T, k), S.reset(), T = k.index, u(e, y, s, E, -1, T, S);
                            var N;
                            N = 0 === S.index ? k.index : s < k.width || S.index === k.index ? S.index : Math.abs(E - S.width) < Math.abs(k.width - E) ? S.index : k.index, w = y.substr(0, N), b += w.replace(/\s$/, ""), b += '<br data-owner="balance-text" />', y = y.substr(N), _--, e.html(y), g = e.width()
                        }
                        e.html(b + y)
                    }
                    e.css({
            ...
            }, e.flag("fullbleedTweaks") && (t(r), t(window).smartresize(r))
        }(t)
